...
- 实施第 21 轮：搜索 suggest 歌单 + 歌手——代码已落地，当前工作区尚未 commit；
- 下一轮：电台大厅或专辑详情。
...
当前已完成到第 21 轮：搜索结果除了单曲，还可以打开歌单和歌手详情。下一轮是电台大厅或专辑详情。活进度见 [`docs/migration/08-progress.md`](./docs/migration/08-progress.md)。
