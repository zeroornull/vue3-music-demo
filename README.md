...
- 实施第 22 轮：`#/album` 专辑详情 + 搜索专辑——代码已落地，当前工作区尚未 commit；
- 下一轮：电台大厅。
...
当前已完成到第 22 轮：搜索结果可以打开歌单、歌手和专辑详情。下一轮是电台大厅。活进度见 [`docs/migration/08-progress.md`](./docs/migration/08-progress.md)。
