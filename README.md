...
- 实施第 18 轮：顶部应用壳（推荐 / 音乐馆 / 搜索）——代码已落地，当前工作区尚未 commit；
- 下一轮：播放器增强。
...
当前已完成到第 18 轮：顶部应用壳把推荐、音乐馆和搜索收成稳定导航。下一轮是播放器增强。活进度见 [`docs/migration/08-progress.md`](./docs/migration/08-progress.md)。
